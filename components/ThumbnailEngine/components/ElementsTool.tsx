...
import { ElementsToolProps } from '../types';

export const ElementsTool: React.FC<ElementsToolProps> = ({
    elementPrompt,
    setElementPrompt,
    elementImage,
    setElementImage,
    ...
    const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                setElementImage(reader.result as string);
            };
        ...
        <div className="space-y-6 animate-[float_0.3s_ease-out]">
            ...
            <div className="space-y-2">
                ...
                <textarea
                    ...
                    placeholder="Describe the main element/character..."
            ...
            <div>
                ...
                {!elementImage ? (
                    ...
                    <div className="relative rounded-xl overflow-hidden border border-white/10 group">
                        <img src={elementImage} alt="Element Ref" className="w-full h-32 object-cover opacity-60" />
